...
class BitcoinUriTest {
    ...
    fun testParseBIP72withFallback() {
        testParse("bitcoin:mq7se9wy2egettFxPbmn99cK8v5AFq55Lx?amount=0.11&r=https://merchant.com/pay.php?h=2a8628fc2fbe", TN,
                BitcoinUri.from(AddressUtils.from(BitcoinTest, "mq7se9wy2egettFxPbmn99cK8v5AFq55Lx"),
                        Value.valueOf(BitcoinTest, 11000000), null, "https://merchant.com/pay.php?h=2a8628fc2fbe"
                ))
    }
    ...
    fun testParseMainnetBip72() {
        testParse("bitcoin:1A3fouaDJA4RRLnQmFxQRh98gr8cFGvwdN?amount=0.11&r=https://merchant.com/pay.php?h=2a8628fc2fbe", PN,
                BitcoinUri.from(AddressUtils.from(BitcoinMain, "1A3fouaDJA4RRLnQmFxQRh98gr8cFGvwdN"),
                        Value.valueOf(BitcoinMain, 11000000), null, "https://merchant.com/pay.php?h=2a8628fc2fbe"))
    }

    @Test
    fun testTestnetAddressOnly() {
        testParse("bitcoin:mq7se9wy2egettFxPbmn99cK8v5AFq55Lx", TN,
                BitcoinUri.from(AddressUtils.from(BitcoinTest, "mq7se9wy2egettFxPbmn99cK8v5AFq55Lx"), null, null, null))
    }
    ...
    fun testMainnetAddressLabelWithPercentageEncoding() {
        testParse("bitcoin:1A3fouaDJA4RRLnQmFxQRh98gr8cFGvwdN?label=counterparty%3A%20burn%20address", PN,
                BitcoinUri.from(AddressUtils.from(BitcoinMain, "1A3fouaDJA4RRLnQmFxQRh98gr8cFGvwdN"), null, "counterparty: burn address", null))
    }
    ...
    fun testMainnetBip21Request50BTCWithMessage() {
        testParse("bitcoin:1A3fouaDJA4RRLnQmFxQRh98gr8cFGvwdN?amount=50&label=Luke-Jr&message=Donation%20for%20project%20xyz", PN,
                BitcoinUri.from(AddressUtils.from(BitcoinMain, "1A3fouaDJA4RRLnQmFxQRh98gr8cFGvwdN"), Value.valueOf(BitcoinMain, 5000000000), "Luke-Jr", null))
    }
    ...
    fun testTestnetAddressAmount() {
        testParse("bitcoin:mq7se9wy2egettFxPbmn99cK8v5AFq55Lx?amount=0.11", TN,
                BitcoinUri.from(AddressUtils.from(BitcoinTest, "mq7se9wy2egettFxPbmn99cK8v5AFq55Lx"),
                        Value.valueOf(BitcoinMain, 11000000), null, null))
    }
    ...
    @Test
    fun testToString() {
        assertEquals("bitcoin:mq7se9wy2egettFxPbmn99cK8v5AFq55Lx", BitcoinUri.from(AddressUtils.from(BitcoinTest,
                "mq7se9wy2egettFxPbmn99cK8v5AFq55Lx"), null, null, null).toString())
        assertEquals("bitcoin:mq7se9wy2egettFxPbmn99cK8v5AFq55Lx?amount=0.11", BitcoinUri.from(AddressUtils.from(BitcoinTest,
                "mq7se9wy2egettFxPbmn99cK8v5AFq55Lx"), Value.valueOf(BitcoinMain, 11000000), null, null).toString())
    }
    ...
    fun testToStringFails() {
        assertNotEquals("According to BIP72, the r-parameter should not be url encoded?", "bitcoin:mq7se9wy2egettFxPbmn99cK8v5AFq55Lx?r=https://merchant.com/pay.php?h%3D2a8628fc2fbe",
                BitcoinUri.from(AddressUtils.from(BitcoinMain, "mq7se9wy2egettFxPbmn99cK8v5AFq55Lx"), null, null, "https://merchant.com/pay.php?h=2a8628fc2fbe").toString())
